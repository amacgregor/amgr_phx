defmodule AmgrWeb.Live.EveShow do
  @moduledoc """
  LiveView Process for rendering Blog posts
  """
  ...
  def mount(%{"id" => id, "preview" => "true"}, _session, socket) do
    id
    |> Amgr.Eve.get_post_preview_by_id!()
    |> show(socket)
  end

  def mount(%{"id" => id}, _session, socket) do
    id
    |> Amgr.Eve.get_post_by_id!()
    |> show(socket)
  end
